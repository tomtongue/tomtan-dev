...
This is because `HadoopTableOperations` has the following implementaion (which is different from other catalogs) for this as below: https://github.com/apache/iceberg/blob/apache-iceberg-1.8.1/core/src/main/java/org/apache/iceberg/hadoop/HadoopTableOperations.java#L259
